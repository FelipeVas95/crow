    ...
    <div class="container">
        <main>
            <div class="py-5 text-center">
                <img src="images/crow.png" width= "90" height="80" />
                <h2><?= trans('auth.Register') ?></h2>
                <p class="lead"><?= trans('auth.login to services') ?></p>
            </div>

            <div class="row g-5">

                <div class="col-md-7 col-lg-8">
                    <h4 class="mb-3"><?= trans('auth.Basic data') ?></h4>
                    <form action="{{ url('/guardar-usuario') }}" method="post" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                                <label for="firstName" class="form-label"><?= trans('auth.Age') ?></label>
                            ...
                            <div class="col-sm-6">
                                <label for="number" class="form-label"><?= trans('auth.Weight') ?></label>
                            ...
                            <div class="col-12">
                                <label for="email" class="form-label"><?= trans('auth.Height') ?> <span
